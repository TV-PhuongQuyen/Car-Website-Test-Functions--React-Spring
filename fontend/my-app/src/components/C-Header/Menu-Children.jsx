            ...
            <div className="menuChildren_container">
                <div className="menuChildren_list">
                    <div className="menuChildren_content">
                        ...
                        <a href="" onClick={() => { navigate("/product") }}><div className="a_menu">PRODUCT</div></a>
                        <a href="" onClick={() => { navigate("/thongke") }}><div className="a_menu">MUSEUM</div></a>
                    </div>
                    <div className="menuChildren_content">
                        <a href="" onClick={() => { navigate("/thongketop") }}><div className="a_menu">BLOG</div></a>
