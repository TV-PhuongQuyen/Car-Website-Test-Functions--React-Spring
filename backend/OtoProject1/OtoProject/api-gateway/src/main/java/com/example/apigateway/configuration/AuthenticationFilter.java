...
public class AuthenticationFilter implements GlobalFilter, Ordered {
    ...
    private String[] pulicEndpoints = {
            ...
            "/file/media/download/.*",
            "/post/post",
            "/profile/user_profile/allProfile",
            "/product/productPublic/search",
            "/product/productPublic/getAllProduct",
            "/product/productPublic/searchText",
            "/product/productPublic/autocomplete"
    };
    ...
    private boolean isPulicEndpoint(ServerHttpRequest request) {
        return Arrays.stream(pulicEndpoints)
